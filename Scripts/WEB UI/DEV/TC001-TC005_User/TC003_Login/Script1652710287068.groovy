...
for (int i = 0; i < 2; i++) {
    ...
    WebUI.setMaskedText(findTestObject('WEBUI-Object/LoginPage/FormEmail'), email[i])

    WebUI.setMaskedText(findTestObject('WEBUI-Object/LoginPage/FormPassword'), password[i])
