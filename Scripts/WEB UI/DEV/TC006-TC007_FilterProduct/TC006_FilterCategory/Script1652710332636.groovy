...
WebUI.click(findTestObject('WEBUI-Object/HomePage/SelectCategory'))

'ubah variabel lewat text object\r\n'
WebUI.click(findTestObject('WEBUI-Object/HomePage/div_alat'))
